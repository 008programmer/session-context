...
## blazor-ui
- **Trigger:** When creating any Blazor UI component
- **Description:** Handles Blazor component structure, conventions, styling, and placement rules
- **Usage:** `/blazor-ui`
- Do NOT write Blazor component code from scratch without invoking this skill first.
-->